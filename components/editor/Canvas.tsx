                    ...
                    return (
                        ...
                        >
                            ...
                            <div
                                ...
                                className={`min-w-0 max-w-full cursor-pointer overflow-hidden rounded-lg p-2 transition ${
                                    isSelected
                            ...
                            >
                                ...
                                {block.type === "double-image" && (
                                    <DoubleImageBlock
                                        ...
                                        leftCaption={
                                            block.props.leftCaption || ""
                                        }
                                        rightSrc={
                                            block.props.rightSrc || ""
                                        }
                                        rightCaption={
                                            block.props.rightCaption || ""
                                        }
                                        gap={
                                            block.props.gap ?? 16
                                        }
